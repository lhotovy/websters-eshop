          ...
          {navLinks.map((link) => {
            return (
              <li key={link.id}>
                <Link 
                  href={link.href} 
                  className="block py-2 pl-3 pr-4 tracking-wider text-white bg-blue-700 rounded md:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500" 
                  aria-current="page"
                >
                  {link.name}
                </Link>
