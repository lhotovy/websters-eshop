...
export const Header = () => {
  ...
  return (
    <>
      <nav className="bg-white dark:bg-amber-900 fixed w-screen z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
        <div className="flex flex-wrap mx-auto items-center justify-between pl-6 py-4 w-5/6">
          ...
          >
            ...
            />
            <span 
              className="self-center hidden md:inline text-xl font-borel uppercase tracking-wide whitespace-nowrap dark:text-white"
            >
              Webster's
            </span>
          </Link>
