...
const ProductList: React.FC<ProductListProps> = ({products}) => {
  return (
    <div className="products m-auto mt-32 mb-32 w-2/3 h-2/3 grid grid-cols-3 gap-6 justify-center">
        ...
        return (      
          <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="px-5 pb-5">
                <Link href={`/eshop/${product.title}`}>
                    <h5 className="text-xl text-center font-semibold tracking-tight text-gray-900 dark:text-white pb-4">{product.name}</h5>
                </Link>
